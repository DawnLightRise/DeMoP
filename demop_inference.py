...
INPUT_CSV = "G_data_llm_20250324.csv"   # 你要推理的数据
OUTPUT_CSV = "inference_predictions.csv"

TEXT_COLUMN = "description"
LABEL_COLUMN = "os_group"  # 若没有标签可设为 None
BATCH_SIZE = 8
MAX_LEN = 512
NUM_EXPERTS = 4
NUM_CLASSES = 2
...
class InferenceDataset(Dataset):
    def __init__(self, df, tokenizer, text_col="description", label_col=None, max_len=512):
        self.df = df.reset_index(drop=False)  # 保留原始 index
    ...
    def __getitem__(self, idx):
        ...
        item = {
            ...
            "row_index": row["index"],  # 原始 dataframe index
        }
