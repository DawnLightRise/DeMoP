> [!NOTE]
>
> **DoMeRa** *(Independent new research project in development by **Chen Tang**, building on insights from DeMoP but separate from DeMoP.)*
>
...
>
> The source code is currently private while the research is ongoing.
